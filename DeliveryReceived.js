     ...
     return (
          <View style={styles.container}>
               ...
               <View style={styles.paymentText}>
                    ...
                    <Text style={styles.paymentTitle}>delivery arrival</Text>
               </View>
               <View style={styles.instructions}>
                    <Text style={styles.instructionsText}>
                    once you received the delivery from Seller, please don’t forget to notify us while clicking on the below button that says “ You received the delivery”
                    </Text>
               </View>
               ...
               <View style={styles.buttonContainer}>
                    <TouchableOpacity style={styles.paymentButton}>
                         <Text style={styles.paymentButtonText}>Delivery Received</Text>
                    </TouchableOpacity>
               </View>
          </View>
     );
