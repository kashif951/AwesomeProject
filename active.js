          ...
          renderItem={({ item, index }) => {
            ...
            return (
              ...
              <TouchableOpacity
                ...
                <Text style={{ padding:12, height: 48, backgroundColor: value == index ? "#EA8C00" : '#F8F8F8', marginLeft: 15, textAlign: 'center', borderRadius: 10, fontSize: 16, fontFamily: 'Nunito-Bold',color:value==index?"#FFF":"#000" }}>{item.name}</Text>
              </TouchableOpacity>
            )
          }}
        />
